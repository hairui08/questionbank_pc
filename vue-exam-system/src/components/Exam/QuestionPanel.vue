<template>
  <div class="question-panel">
    ...
    <div class="question-content" :style="{ fontSize: fontSizeMap[fontSize] }">
      ...
      <div v-if="question.type === 'judgment'" class="judgment-area">
        <button
          ...
          :class="{ 'is-selected': userAnswer === 'true' }"
        ...
        <button
          class="judgment-button"
          :class="{ 'is-selected': userAnswer === 'false' }"
    ...
    <div class="panel-footer">
      ...
      <button class="action-button primary" @click="toggleAnalysis">
