<template>
  <BaseModal :visible="show" :show-footer="false" width="420px" @update:visible="(val) => !val && $emit('close')">
    <template #header>
...
.close-btn{border:none;background:transparent;font-size:18px;cursor:pointer;color:#666}
.close-btn:hover{color:#ff443d}
</style>
